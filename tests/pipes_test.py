...
def test_temperature(pipe_fixture, segment_ratios, T_b, z, expected, request):
    ...
    # Fluid temperatures [degC]
    T_f = pipe.get_temperature(z, T_f_in, T_b, m_flow_borehole, fluid.cp, segment_ratios=segment_ratios)
    assert np.allclose(T_f, expected)
